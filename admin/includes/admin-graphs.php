                    ...
                    <div class="col-sm-6">
                        <div class="btn-group btn-group-toggle float-right text-success" data-toggle="buttons">
                            <label class="btn btn-sm btn-success btn-simple active" id="0">
                                ...
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Objave</span>
                            ...
                            <label class="btn btn-sm btn-success btn-simple" id="1">
                                ...
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Komentari</span>
                                <span class="d-block d-sm-none">
                            ...
                            <label class="btn btn-sm btn-success btn-simple" id="2">
                                ...
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Korisnici</span>
                                <span class="d-block d-sm-none">
